...
if(pre<=nowLeft+Math.floor((1/len)*100)+5){nav.find(".realBorder")
.css({
	left:pre+"%",
...
var nowLeft=0;
	...
	(opts.conSelector+'.swiper-container',
	{direction:'horizontal',observer:true,observeParents:true,onTouchStart:function(swiper)
	{nowLeft=((parseInt(nav.find(".realBorder").css('left'))/swiper.width)*100)},onTouchMove:function(swiper,e){movePanel(swiper.width,swiper)},
	...
	onTransitionStart:function(swiper){
		var pre=0;var direction=getDirection(swiper),
		index=swiper.activeIndex;
		if(index==2){
			$(".boxder").animate({left:"77%"})
		}
		if(index==1){
			$(".boxder").animate({left:"44%"})
		}
		if(index==0)
		{
				$(".boxder").animate({left:"11%"})
			if(direction=="right")
			{
