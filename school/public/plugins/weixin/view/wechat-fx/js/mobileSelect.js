			...
			for(var i=0; i<wheelsData.length; i++){ //列
				...
				if(_this.jsonType){
					for(var j=0; j<wheelsData[i].data.length; j++){ //行
						tempHTML += '<li class="zj" data-id="'+wheelsData[i].data[j].id+'">'+wheelsData[i].data[j].value+'</li>';
					}
				}else{
					for(var j=0; j<wheelsData[i].data.length; j++){ //行
						tempHTML += '<li class="zj" data-sok="">'+wheelsData[i].data[j]+'</li>';
					}
				}
				tempHTML += '</ul></div>';
			}
...
//		var tempHTML='';
//			for(var i=0; i<wheelsData[0].data.length; i++){ //列
//				console.log(wheelsData[0].data)
//              
//				var pw = wheelsData[0].data
//				for(var i=0; i<pw.length; i++){
//					console.log(pw[i].province)
//					tempHTML += '<div class="wheel"><ul class="selectContainer">';
//				if(_this.jsonType){
//					for(var i=0; i<pw.length; i++){ 
//						//行
//						tempHTML += '<li data-id="'+pw[i].provinceid+'">'+pw[i].province+'</li>';
//					}
//				}else{
//					for(var i=0; i<pw.length; i++){ //行
//						
//						tempHTML += '<li data-id="'+pw[i].provinceid+'">'+pw[i].province+'</li>';
//					}
//				}
